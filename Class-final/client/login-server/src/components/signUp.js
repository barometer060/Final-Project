...
class SignUp extends Component {
  ...
  componentWillMount() {
    fetch("http://localhost:8000/rest/api/users/signUp/securityQ")
      .then(ques => {
        return ques.json();
      })
      .then(data => {
        var options = data.map(item => {
          return (
            <option key={item.quesId} value={item.quesId}>
              {item.question}
            </option>
          );
        });
  ...
  validateEmail() {
    ...
    if (this.state.emailId && this.state.emailId != "") {
      fetch("http://localhost:8000/rest/api/users/signUp/emailId", {
        method: "post",
        headers: {
  ...
  validatePhone() {
    if (this.state.phoneNumber && this.state.phoneNumber != "") {
      fetch("http://localhost:8000/rest/api/users/signUp/phoneNumber", {
        method: "post",
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json"
  ...
  handleOnSubmit(event) {
    ...
    fetch("http://localhost:8000/rest/api/users/signUp/insertUserDetails", {
      method: "put",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json"
  ...
  render() {
    ...
    if (
      !this.state.isFresh &&
      !this.state.checkSecQ &&
      !this.state.checkEmailID &&
      !this.state.checkPhoneNumber &&
      ...
      submitButton = (
        <button type="submit" className="abc" disabled>
          Submit
        </button>
      );
    }
          ...
          <table>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <input type="text" required onChange={this.noteFirstName} />
                </td>
              </tr>
              <tr>
                <td>
                ...
                <td>
                  <input type="text" onChange={this.noteLastName} />
                </td>
              </tr>
              <tr>
                <td>
                ...
                <td>
                  <input
                    type="email"
                    required
                    onChange={this.noteEmail}
                    onBlur={this.validateEmail}
                  />
                  {this.state.checkEmailID && (
                    <span className="warning">Email is already registered</span>
                  )}
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <input
                    type="password"
                    required
                    onChange={this.notePassword}
                    onBlur={this.handlePasswordCheck}
                  />
                  <br />
                  {this.state.passChecked && (
                    <span className="warning">
                      Password should contain one captial letter, one number and
                      a special character{" "}
                    </span>
                  )}
                </td>
              ...
              <tr>
                ...
                <td>
                  <input
                    type="password"
                    required
                    onChange={this.noteConfirmPassword.bind(this)}
              ...
              <tr>
                ...
                <td>
                  <input type="date" required onChange={this.noteDOB} />
                </td>
              </tr>
              <tr>
                <td>
                ...
                <td>
                  <input type="text" required onChange={this.noteLandmark} />
                </td>
              </tr>
              <tr>
                <td>
                ...
                <td>
                  <input type="text" required onChange={this.noteCity} />
                </td>
              </tr>
              <tr>
                <td>
                ...
                <td>
                  <input type="number" required onChange={this.notePincode} />
                </td>
              </tr>
              <tr>
                <td>
              ...
              <tr>
                ...
                <td>
                  <input
                    type="text"
                    required
                    onChange={this.noteAnswer.bind(this)}
                  />
                </td>
              </tr>
              <tr>
